            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white">
                        <h3 class="mb-0">Add Parking Slot</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.parking.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="slot_number" name="slot_number" placeholder="Enter slot number" required>
                            </div>
                            <div class="form-group">
                                <label for="floor_number" class="font-weight-bold">Floor Number</label>
                                <input type="number" class="form-control" id="floor_number" name="floor_number" placeholder="Enter floor number" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group" id="purchaserNameField" style="display: none;">
                                <label for="purchaser_name" class="font-weight-bold">Purchaser Name</label>
                                <input type="text" class="form-control" id="purchaser_name" name="purchaser_name" placeholder="Enter purchaser name">
                            </div>
                            <div class="form-group">
