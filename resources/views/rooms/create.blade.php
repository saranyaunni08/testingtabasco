                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="input-group input-group-dynamic mb-4">
                        ...
                        <input type="text" name="room_floor" class="form-control" style="text-transform: uppercase;">
                      </div>
                    </div>

                    <div class="col-md-6">
                      <div class="input-group input-group-dynamic mb-4">
                        <select name="room_type" class="form-select" style="text-transform: uppercase;">
                    ...
                    {{-- <div class="col-md-6" id="carParkingFields" style="display: none;">
                      ...
                      <div class="input-group input-group-dynamic mb-4">
                        <select name="parking_type" class="form-select" style="text-transform: uppercase;">
                      ...
                      <div class="input-group input-group-dynamic mb-4">
                        ...
                        <input type="text" name="parking_area" class="form-control" style="text-transform: uppercase;">
                      </div>
                      <div class="input-group input-group-dynamic mb-4">
