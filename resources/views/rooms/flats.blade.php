                            ...
                            <tbody>
                                @forelse ($rooms as $room)
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            <a href="{{ route('admin.rooms.edit', $room->id) }}" class="btn btn-success btn-sm me-2">
                                        ...
                                        @else
                                            @if ($room->sale)
                                                <a href="{{ route('admin.customers.show', ['customerName' => $room->sale->customer_name]) }}" class="btn btn-outline-success btn-sm">
                                                    View
                                                </a>
                                            @else
