@extends('layouts.default', ['title' => 'Chair Spaces'])
            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-info shadow-info border-radius-lg pt-4 pb-3 d-flex justify-content-between align-items-center">
                        ...
                        <!-- Add this block for the link to create room page -->
                        <a href="{{ route('admin.rooms.create', ['building_id' => $building_id, 'room_type' => 'Chair space']) }}" 
                            class="btn btn-outline-light float-end" style="background-color: #ffffff; border-color: #007bff;
                             ...
                             onmouseout="this.style.backgroundColor='#ffffff'; this.style.color='#007bff'">Add Chair space</a>
                    </div>
                </div>
            </div>
    <div class="card">
