    ...
    <table>
        ...
        <tbody>
            ...
            <tr class="sub-total">
                ...
                <td>{{ number_format($installments->sum('debit'), 2) }}</td>
                <td>{{ number_format($installments->sum('credit'), 2) }}</td>
                <td>{{ number_format($installments->last()->balance ?? 0, 2) }}</td>
            </tr>
